...
<div id="background2">
	<div id="ac"><h2 style="color: red;position: relative;margin-left: 15px;top: 5px;font-family: sans-serif;">Repair</h2></div>
	<div id="line"></div>
	<div id="line1"></div>
	<div id="im"><img src="images/Air_conditioner.jpg" style="height: 250px;width:550px;position: relative;top: 14px;margin-left: 14px; ">
	...
	<div id="data">
		<form method="post" action="AC.php">
			<table style="position: relative;margin-left: 150px;top: 40px;" align="center">
				...
				<tr><td><label style="font-family: sans-serif;font-size: 20px;">Desired Service</label></td>
					<td><select style="width: 170px;height: 30px;font-size: 15px;" name="service">
	...
	<div id="scroll">
		<table style="position: relative;top: 0px;">
			...
			<tr><td>Computer Switch Installation</td><td>RS. 180/-</td></tr>
			<tr><td>Cassate AC gas refilling @Rs.1499/-per tonn</td><td>RS. 1499/-</td></tr>
			<tr><td>Cassate Car gas refilling @Rs.999/-per tonn</td><td>RS. 999/-</td></tr>
			<tr><td>Cassate Computer servicing @Rs.799/-</td><td>RS. 799/-</td></tr>
			<tr><td>Cassate Mobile servicing @Rs.999/-</td><td>RS. 999/-</td></tr>
			<tr><td>Split Refrigrator  Fitting</td><td>RS. 1700/-</td></tr>
			<tr><td>Split AC Gas filling-1 ton</td><td>RS. 1499/-</td></tr>
			<tr><td>Split Washing Machine Gas filling-1.5 ton</td><td>RS. 1999/-</td></tr>
			<tr><td>Split MotorCycle Gas filling-2 ton</td><td>RS. 1999/-</td></tr>
			<tr><td>Split AC Gas filling-2.5 ton</td><td>RS. 2500/-</td></tr>
			<tr><td>Split Service Removal</td><td>RS. 800/-</td></tr>
			<tr><td>Split Service Servicing</td><td>RS. 199/-</td></tr>
...
if(isset($_POST['submit']))
{
	...
	$query="insert into repair(select_city,desired_service,area_pin,area,date,problem)values('$city','$service','$pin','$area','$date','$problem')";
