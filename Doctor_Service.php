...
<div id="background2">
	<div id="ac"><h2 style="color: red;position: relative;margin-left: 15px;top: 5px;font-family: sans-serif;">Doctors</h2></div>
	<div id="line"></div>
	<div id="line1"></div>
	<div id="im"><img src="images/6.jpg" style="height: 250px;width:95%;position: relative;top: 14px;margin-left: 14px; ">
	...
	<div id="data">
		<form method="post" action="Doctor_Service.php">
			<table style="position: relative;margin-left: 150px;top: 40px;" align="center">
				...
				<tr><td><label style="font-family: sans-serif;font-size: 20px;">Select Doctor</label></td>
					<td><select style="width: 170px;height: 30px;font-size: 15px;" name="doctor">
						<option value="Ayurvedic" >Ayurvedic</option>
						<option value="Cardiologists">Cardiologists</option>
						<option value="Chest Specialists">Chest Specialists</option>
...
if(isset($_POST['submit']))
{
	...
	$query="insert into doctor(select_city,doctor,area_pin,area,date,problem)values('$city','$doctor','$pin','$area','$date','$problem')";
